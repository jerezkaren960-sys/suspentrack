...
DROP DATABASE IF EXISTS suspentrack;
CREATE DATABASE suspentrack;
USE suspentrack;
...
-- ============================================
CREATE INDEX idx_vehiculo_componente ON componentes(vehiculo_id);
CREATE INDEX idx_inspeccion_fecha ON inspecciones(fecha);
CREATE INDEX idx_mantenimiento_fecha ON mantenimientos(fecha);
CREATE INDEX idx_alertas_nivel ON alertas(nivel, fecha);
CREATE INDEX idx_vehiculo_criticidad ON vehiculos(criticidad);
CREATE INDEX idx_vehiculo_estado ON vehiculos(estado_general);
...
-- ============================================
INSERT INTO vehiculos (placa, marca, modelo, anio, kilometraje, capacidad_carga, frecuencia_uso, estado_general) VALUES
...
-- ============================================
INSERT INTO componentes (vehiculo_id, nombre, estado, fecha_inspeccion)
